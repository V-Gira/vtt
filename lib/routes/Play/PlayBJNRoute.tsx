...
export const PlayBJNRoute: React.FC<{
  match: {
    params: { id?: string };
  };
}> = (props) => {
  ...
  const shareLink = `${location.origin}/playBJN/${hostManager.state.hostId}`;
...
PlayBJNRoute.displayName = "PlayBJNRoute";
export default PlayBJNRoute;
